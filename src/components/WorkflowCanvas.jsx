...
const COLLAPSED_HEIGHT = 34; // Height when collapsed (just label bar)
const TASK_GAP = 18;
const LANE_GAP = 12;
const DOC_LEFT_X = 20;
...
// ── Get effective height of a tool (collapsed or expanded) ──
...
const getTaskY = (task, tasks, tools, collapsedTools) => {
  ...
  // If tool is collapsed, don't render tasks in this lane
  ...
  // Calculate Y position accounting for collapsed lanes before this tool
  let baseY = 50;
...
const WorkflowCanvas = ({ activity, filters, toolNotes, onToolNoteChange }) => {
  ...
  // Calculate canvas height accounting for collapsed lanes
